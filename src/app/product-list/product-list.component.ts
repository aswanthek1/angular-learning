...
@Component({
  ...
  standalone: true,
  imports: [CommonModule, ProdcutComponent, FilterComponent],
...
export class ProductListComponent {
  ...
  totalProductInStock:number = this.products.filter((item) => item.is_in_inventory === true).length;
  totalProductOutOfStock:number = this.products.filter((item) => item.is_in_inventory === false).length;
